  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/cheekyGamer0429/Arcade-random/blob/main/MAIN_CODE.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        ...
        "      output_board(arr)\n",
        "\n",
        "def upd_board(arr,value,acc_values):\n",
        "  global winner\n",
        "  if value == 1:\n",
        "    while True:\n",
        "      bot_change(arr)\n",
